...
from .views import MatchResultViewSet, TriggerMatchView, TopCandidatesView, MatchingConfidenceView
...
urlpatterns = [
    ...
    path("confidence/", MatchingConfidenceView.as_view(), name="matching-confidence"),
]
